    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-20">
      ...
      <section className="grid md:grid-cols-2 gap-12">
        <motion.div className="bg-gray-800/50 p-8 rounded-xl backdrop-blur-sm">
          ...
          <h2 className="text-2xl font-bold mb-4 text-white">Our Vision</h2> {/* Changed text color to text-white */}
        ...
        <motion.div>
          <Target className="h-12 w-12 text-primary-500 mb-4" />
          <h2 className="text-2xl font-bold mb-4 text-white">Our Mission</h2> {/* Changed text color to text-white */}
          <p className="text-gray-300">
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div className="bg-gray-800/50 p-6 rounded-xl backdrop-blur-sm text-center">
              <div className="flex justify-center mb-4">{feature.icon}</div>
              <h3 className="text-xl font-bold mb-2 text-white">{feature.title}</h3> {/* Changed text color to text-white */}
